...
class Beam:
    ...
    def __init__(self, bird):
        ...
        self._rct = self._img.get_rect()
        self._rct.centerx = bird._rct.centerx + bird._rct.width/2 + 20      #こうかとんの右の座標 
        self._rct.centery = bird._rct.centery                               #縦は変わらない
        self.vx, self.vy = +1, 0
...
class Bomb:
    ...
    爆弾に関するクラス
    """
    _colors = [(255, 0, 0), (0, 255, 0), (0, 0, 255)]            #色を先に生成
    _dires = [-1, 0, 1]
    def __init__(self):
        """
...
def main():
    ...
    bird = Bird(3, (900, 400))
    bombs = [Bomb() for i in range(NUM_OF_BOMB)]
    beam = None
